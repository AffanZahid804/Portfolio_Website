  ...
  const experiences = [
    {
      ...
      description: 'Architecting and delivering scalable web and mobile applications with React Native, Node.js, NestJS, and PostgreSQL for production-ready platforms.',
      achievements: [
        'Architected and delivered advanced mobile features using React Native and Node.js, improving app performance and user engagement',
        'Designed real-time push notification system using Firebase Cloud Messaging (FCM) for cross-platform delivery',
        'Built scalable chat module using Socket.io with real-time synchronization and message persistence',
        'Developed RESTful APIs and event management system supporting high-concurrency workloads',
        'Implemented OAuth 2.0 and JWT-based authentication with Google, Apple, and LinkedIn social logins',
        'Leveraged MongoDB geospatial queries for location-based discovery features',
        'Built a full-stack real-estate listing platform using NestJS and PostgreSQL, deployed on AWS with a secure admin portal',
      ],
      technologies: ['React Native', 'Node.js', 'NestJS', 'PostgreSQL', 'MongoDB', 'AWS', 'Socket.io', 'Firebase FCM', 'OAuth 2.0', 'JWT'],
      color: '#ec4899',
    },
    {
      type: 'fulltime',
      ...
      technologies: ['React.js', 'Node.js', 'RESTful APIs', 'JavaScript', 'HTML/CSS'],
      color: '#6366f1',
    },
    {
      type: 'fulltime',
      ...
      technologies: ['React.js', 'Next.js', 'JavaScript', 'RESTful APIs', 'HTML/CSS'],
      color: '#8b5cf6',
    },
    {
      type: 'fulltime',
      ...
      technologies: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'Stripe', 'PayPal'],
      color: '#f97316',
    },
    {
      type: 'freelance',
      ...
      description: 'Delivered custom web and mobile applications for international clients on time and within budget.',
      achievements: [
        'Delivered 5+ custom web and mobile applications for international clients on time and within budget',
        'Built React.js, Next.js, and React Native solutions with full deployment and handoff',
      ],
      technologies: ['React.js', 'React Native', 'Next.js', 'Node.js', 'JavaScript'],
      color: '#10b981',
    },
  ]
