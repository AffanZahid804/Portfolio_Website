...
export const themes = {
  slate: {
    ...
    gradient3: 'linear-gradient(135deg, #262626 0%, #404040 100%)',
    glowRgb: '59, 130, 246',
    aurora1: 'rgba(59, 130, 246, 0.10)',
    aurora2: 'rgba(80, 80, 80, 0.05)',
    aurora3: 'rgba(30, 58, 138, 0.09)',
  },
  midnight: {
    name: 'Midnight',
    primary: '#60a5fa',
    ...
    glowRgb: '96, 165, 250',
    aurora1: 'rgba(96, 165, 250, 0.09)',
    aurora2: 'rgba(40, 40, 60, 0.06)',
    aurora3: 'rgba(30, 58, 138, 0.08)',
  },
  ocean: {
    name: 'Ocean',
    primary: '#0891b2',
